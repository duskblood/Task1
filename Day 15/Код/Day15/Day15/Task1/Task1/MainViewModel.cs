...
namespace Task1
{
    public class MainViewModel : INotifyPropertyChanged
    {
        ...
        private void AddProduct(object parameter)
        {
            ...
            if (addProductWindow.ShowDialog() == true)
            {
                Products.Add(new Product
                {
                    ...
                    Category = addProductWindow.ProductCategory
                });
            }
        }
        ...
        private void EditProduct(object parameter)
        {
            ...
            var editProductWindow = new EditProductWindow(SelectedProduct.Name, SelectedProduct.Quantity, SelectedProduct.Price, SelectedProduct.Category);
            if (editProductWindow.ShowDialog() == true)
            {
                ...
                SelectedProduct.Price = editProductWindow.ProductPrice;
                SelectedProduct.Category = editProductWindow.ProductCategory;
            }
        }
